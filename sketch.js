...
function draw() {
      if (sceneMgr == 3) { lvl = 1 }
  else if (sceneMgr == 4) { lvl = 2 }
  else if (sceneMgr == 6) { lvl = 3 }
  
    if (sceneMgr === 1) {sceneAttract()} 
    else if (sceneMgr === 2) {sceneIntro() }
    else if (sceneMgr === 3) {game(60, 0.05, 20, 20, 200, -200) }
    ...
    else if (sceneMgr === 4 || sceneMgr === 6) {sceneMaus() }
    else if (sceneMgr === 5) {game(40, 0.05, 20, 50, 500, 80) }
    else if (sceneMgr === 7) {game(30, 0.05, 30, 30, 700, 300) }
    else if (sceneMgr === 8) {sceneWin() }
    else if (sceneMgr === 9) {sceneDie() }
    }
  ...
  class food {
    ...
    constructor(raL, raH) {
      ...
      this.rWidth = random (350,650);
       this.rad = (this.rWidth*0.5);
      if(dist(this.posX, this.posY, mouseX, mouseY) < this.rad) {this.interact();}
      if(dist(this.posX, this.posY, mouseX, mouseY) < this.rad) {this.interact();}
      ...
      interact() {
             ...
             if (this.posX <= 299) {this.posX = random (0,299) } 
             else {this.posX = random (300,600)}
            this.posY = random (0,600)
            this.rWidth = random (350,650)
         this.rad = (this.rWidth*0.5);
...
function game(_tt, _ts, _fs, _cs, win, die) {
  ...
  if (score >= win) {sceneMgr ++} 
  else if (score <= die) {sceneMgr = 9} 
...
function mousePressed() {
  ...
  else if (sceneMgr == 2 && clickFlag == 1) {sceneMgr ++}

  else if (sceneMgr == 2 && clickFlag == 2) {sceneMgr = 1}
